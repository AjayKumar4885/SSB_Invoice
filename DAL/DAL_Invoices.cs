                ...
                if (_objUpdateInvoice != null)
                {
                    ...
                    using (LocalEntity _context = new LocalEntity())
                    {
                        ...
                        if (_Invoice != null)
                        {
                            ...
                            _Invoice.Remark = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.DeliveryTerms = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.DeliveryType = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.Port = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.PaymentTerms = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.DeliveryPeriod = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.WODelivery = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.Remarks = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.WORemarks = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.Note = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.PartialShip = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);
                            _Invoice.TransShipment = string.IsNullOrWhiteSpace(_objUpdateInvoice.PartyNo) ? _Invoice.PartyNo : Convert.ToString(_objUpdateInvoice.PartyNo);

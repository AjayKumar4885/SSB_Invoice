    ...
    public partial class CreateInvoice : Form
    {
        ...
        private void CreateInvoiceDetails()
        {
            ...
            if (string.IsNullOrWhiteSpace(txtBoxInvoiceNo.Text))
            {
                ...
                {
                    MessageBox.Show(item.Info, "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                }
            }
            else //Update
            {
        ...
        private void AddItemDetails()
        {
            ...
            if (!string.IsNullOrWhiteSpace(lblArtId.Text) && !string.IsNullOrWhiteSpace(txtboxQty.Text))
            {
                ...
                {
                    MessageBox.Show("Please select refile Ink before adding item !!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
